// pnp:/home/mamluk/Tier/esbuild-test/src/notFound.ts
var notFoundPattern = new URLPattern({ pathname: "*" });
var notFoundRoute = {
...
// pnp:/home/mamluk/Tier/esbuild-test/.yarn/cache/urlpattern-polyfill-npm-1.0.0-rc1-2328908e80-7d29a53863.zip/node_modules/urlpattern-polyfill/src/path-to-regex-modified.ts
...
// pnp:/home/mamluk/Tier/esbuild-test/.yarn/cache/urlpattern-polyfill-npm-1.0.0-rc1-2328908e80-7d29a53863.zip/node_modules/urlpattern-polyfill/src/url-utils.ts
var DEFAULT_OPTIONS = {
  delimiter: "",
  prefixes: "",
  sensitive: true,
...
// pnp:/home/mamluk/Tier/esbuild-test/.yarn/cache/urlpattern-polyfill-npm-1.0.0-rc1-2328908e80-7d29a53863.zip/node_modules/urlpattern-polyfill/src/url-pattern-parser.ts
var Parser = class {
  input;
  tokenList = [];
  internalResult = {};
...
// pnp:/home/mamluk/Tier/esbuild-test/.yarn/cache/urlpattern-polyfill-npm-1.0.0-rc1-2328908e80-7d29a53863.zip/node_modules/urlpattern-polyfill/src/url-pattern.ts
var COMPONENTS = [
  "protocol",
  "username",
  "password",
...
function tokensToPattern(tokens, options) {
  ...
  for (const token of tokens) {
    ...
    const needsGrouping = token.suffix !== "" || token.prefix !== "" && (token.prefix.length !== 1 || !optionsPrefixes.includes(token.prefix));
...
// pnp:/home/mamluk/Tier/esbuild-test/src/router.ts
var routeMatcher = (routes, headers) => {
  const pathname = headers[":path"];
  const route = routes.find((route2) => route2.pattern.test({ pathname }));
  if (route == null) {
